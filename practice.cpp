...
int main()
{
    // array<int, 5> a;
    // a.at(0) = 1;
    // // If you try to create array w/o mentioning it's size it will not get created whereas in the case of vector it will get created
    // // array<int> 5; // not going to happen
    // // vector<int> v;
    ...
    // // As it is dynamic across rows as well as column it will get created for sure.
    ...
    // arr[0][1] = 20; 
    // // 2-D vector
    // vector<vector<int>> v1(5, vector<int>(5, 10));
    ...
    // }
    // // 3-D vector
    // vector<vector<vector<int>>> v2(5, vector<vector<int>> (10, vector<int> (20, 10)));
    // // 4-D vector
    // vector<vector<vector<vector<int>>>> v3(10, vector<vector<vector<int>>> (20, vector<vector<int>> (30, vector<int> (40, 40))));
    // // Arrays
    // array<int, 5> arr1;
    // arr1.at(0) = 5;
    // arr1.at(1) = 10;
    ...
    //     cin >> x;
    //     s.insert(x);
    //     cout << *s.begin() << " "; // for printing the element of the set not it's memory address

    //     cout << *s.begin() + 1 << " "; // for printing 1st index element from the set
    // }
    // // In this case we have to use (*i) to print elements else it will give error
    // for (auto it = s.begin(); it != s.end(); it++)
    // {
    //     cout << *it << " ";
    // }
    // // In this case we have to use (it) to print elements else it will give error
    // for(auto it : s)
    // {
    //     cout << it << " ";
    // }
    ...
    // int findelementbyindex = findelement - arr;
    // cout << findelementbyindex << endl;

    // auto findelement = upper_bound(arr, arr + n, x);
    // int findelementbyindex = findelement - arr;
    // cout << findelementbyindex << endl;
    sort(arr, arr + n);
    for (int i = 0; i < n; i++)
    ...
    int last_occurence = upper_bound(arr, arr + n, x) - arr;
    int first_occurence = lower_bound(arr, arr + n, x) - arr;

    int totaloccurence = last_occurence - first_occurence;

    if (arr[first_occurence] == x && arr[last_occurence] == x && last_occurence >= 0 && first_occurence >= 0) 
    {
        cout << "Total occurence of an element : " << totaloccurence << endl;
    }
    else
    {
        cout << "Not present in the array" << endl;
    }
    // if (arr[lastoccurenceofindex] == x && lastoccurenceofindex >= 0)
    // {
    //     cout << "Element found at : " << lastoccurenceofindex << endl;
    // }
    // else
    // {
